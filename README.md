...
| [skim](https://github.com/skim-rs/skim) | Fuzzy finder in Rust — an alternative to fzf | ```sk``` | 4.8.0<br>2026-06-17 |
...
| [cargo-binstall](https://github.com/cargo-bins/cargo-binstall) | Install prebuilt Rust binaries without having to compile from source | ```cargo-binstall``` | 1.20.1<br>2026-06-21 |
...
| [cargo-deny](https://github.com/EmbarkStudios/cargo-deny) | Lint your dependencies: licenses, bans, advisories, sources | ```cargo-deny``` | 0.19.9<br>2026-06-15 |
...
| [cargo-expand](https://github.com/dtolnay/cargo-expand) | Shows the result of macro expansion and `#[derive]` expansion | ```cargo-expand``` | 1.0.123<br>2026-06-16 |
| [cargo-generate](https://github.com/cargo-generate/cargo-generate) | A developer tool to help you get up and running quickly with a new Rust project | ```cargo-generate``` | 0.23.12<br>2026-06-12 |
...
| [cargo-nextest](https://github.com/nextest-rs/nextest) | A next-generation test runner for Rust — up to 3x faster than `cargo test` | ```cargo-nextest``` | 0.9.138<br>2026-06-21 |
...
| [cargo-tarpaulin](https://github.com/xd009642/tarpaulin) | A code coverage tool for Rust projects | ```cargo-tarpaulin``` | 0.35.5<br>2026-06-20 |
...
| [cargo-update](https://github.com/nabijaczleweli/cargo-update) | Cargo subcommand for checking and applying updates to installed executables | ```cargo-install-update``` | 20.0.2<br>2026-06-09 |
...
| [bottom](https://github.com/ClementTsang/bottom) | Yet another cross-platform graphical process/system monitor | ```btm``` | 0.14.1<br>2026-06-22 |
| [gping](https://github.com/orf/gping) | Ping, but with a graph | ```gping``` | 1.20.2<br>2026-06-14 |
...
| [topgrade](https://github.com/topgrade-rs/topgrade) | Upgrade all the things — a unified upgrade runner for many package managers | ```topgrade``` | 17.6.2<br>2026-06-20 |
...
| Name | Description | Executable(s) | Latest Release |
|:-----|:------------|:--------------|:--------------|
| [jaq](https://github.com/01mf02/jaq) | A clone of jq — a JSON data processing tool | ```jaq``` | 3.1.0<br>2026-06-11 |
...
| [xan](https://github.com/medialab/xan) | The CSV magician — process CSV files from the command line | ```xan``` | 0.59.0<br>2026-06-17 |
...
| [just](https://github.com/casey/just) | A handy way to save and run project-specific commands — a modern `make` | ```just``` | 1.53.0<br>2026-06-16 |
...
| [typst-cli](https://github.com/typst/typst) | A new markup-based typesetting system for the sciences | ```typst``` | 0.15.0<br>2026-06-15 |
...
| Name | Description | Executable(s) | Latest Release |
|:-----|:------------|:--------------|:--------------|
| [oxipng](https://github.com/shssoichiro/oxipng) | A multithreaded lossless PNG compression optimizer | ```oxipng``` | 10.1.1<br>2026-04-22 |
