...
Release metadata such as `version` and `last_release` is generated by automation. Please do not
add or edit those fields in pull requests.
...
| `version`     | no       | Generated by automation; do not edit in community PRs          |
| `last_release`| no       | Generated by automation; do not edit in community PRs          |
...
5. Run `cargo +nightly -Zscript scripts/readme.rs` and commit the regenerated `README.md`
...
- Unique crate names across categories
- Unique, lowercase, hyphen-separated category slugs
- Cargo subcommands (`cargo-*`) are in the Cargo Subcommands category
- Newly added crates exist on crates.io unless explicitly opted out
- Valid JSON structure
- An up-to-date generated `README.md`
...
# check README without rewriting it
cargo +nightly -Zscript scripts/readme.rs -- --check
